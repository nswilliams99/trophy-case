# The Trophy Case — Website & Digital Strategy Proposal

**Prepared for:** Gregg Schmidt, Owner
**Business:** The Trophy Case, 303 N Main St, Fremont, NE 68025
**Date:** February 2026
...
| Metric | Current (Wix Site) | Local Leader (Center Trophy) |
|---|---|---|
| Monthly organic traffic | **0.8 visits** | 454 visits |
| Organic keywords ranked | 5 | 93 |
...
|---|---|---|
| "trophy shop" + city terms (Omaha/Fremont) | ~200/mo | Low (KD 3-5) |
| "near me" trophy/engraving searches | ~70/mo local | Low-Medium (KD 4-33) |
| "custom medals" (national) | 4,400/mo | Medium (KD 18) |
| "custom plaques" (national) | 6,600/mo | Medium (KD 23) |
...
| Timeline | Local Visits | E-Commerce Visits | Total Monthly |
|---|---|---|---|
| Month 6 | 55-100 | 30-80 | 85-180 |
| Month 12 | 150-250 | 150-400 | 300-650 |
| Month 18 | 220-350 | 400-900 | 620-1,250 |
| Month 24 | 270-440 | 600-1,400 | 870-1,840 |
...
## Immediate Priority: Google Business Profile

Regardless of which option you choose, **optimizing your Google Business Profile should start immediately.** It doesn't depend on the website and delivers the fastest results.

### Current State
- 6 reviews at 4.3 stars
- Not appearing in the Google Map Pack for any trophy-related searches

### What Needs to Happen
1. Complete all GBP fields (hours, services, attributes, description)
2. Add 20+ high-quality photos of your shop and products
3. Begin review generation — goal: 40+ reviews at 4.5+ stars within 6 months
4. Post weekly updates (new products, seasonal promotions, community involvement)
...
Our research confirmed that Google Ads are **cost-prohibitive** for this industry:

| Channel | Cost Per Customer Acquired | Typical Order Value | Return |
|---|---|---|---|
| Google Ads (medals) | ~$300 per sale | $50-$75 | **Lose $225-$250 per sale** |
...
| Week | Milestone |
|---|---|
| Week 1-2 | GBP optimization, design mockups, Shopify store setup |
| Week 3-4 | Lead-gen site: homepage, service pages, area pages |
| Week 5-6 | Shopify: product catalog, collections, Zakeke configuration |
...
- On-page SEO optimization (meta tags, schema markup, internal linking)
- Google Analytics 4 + Search Console setup
- Google Business Profile optimization
- XML sitemap and robots.txt configuration
- 301 redirects from existing Wix site
...
- Collection pages with SEO-optimized content
...
*This proposal is based on competitive analysis, keyword research, market sizing, and traffic modeling conducted using DataForSEO, Semrush data, and direct competitor audits. All projections use conservative estimates — actual results may exceed these figures with consistent execution.*
